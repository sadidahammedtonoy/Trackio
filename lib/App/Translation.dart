...
class AppTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      "Continue as Guest' on the login screen. Your data will be stored under an anonymous Firebase UID. If you logout as guest, data may be lost.":
          "Continue as Guest' on the login screen. Your data will be stored under an anonymous Firebase UID. If you logout as guest, data may be lost.",
      ...
      "This will set Overall Saving to 0. Continue?":
          "This will set Overall Saving to 0. Continue?",
      ...
      "Anything you want to remember about this saving...":
          "Anything you want to remember about this saving...",
      ...
      "You're using Trackio offline. Please connect to the internet.":
          "You're using Trackio offline. Please connect to the internet.",
      ...
      "Cannot set reminder for past time": "Cannot set reminder for past time",
      ...
      "Never forget important tasks add your reminder now.":
          "Never forget important tasks add your reminder now.",
      ...
      "Are you sure you want to delete this reminder?":
          "Are you sure you want to delete this reminder?",
      "Reminder removed successfully": "Reminder removed successfully",
      "Mon": "Mon",
      "Tue": "Tue",
      "Wed": "Wed",
      "Thu": "Thu",
    ...
    'bn_BD': {
      ...
      "Reminders": "রিমাইন্ডারসমূহ",
      "No Reminders Yet": "এখনও কোনো রিমাইন্ডার নেই",
      "Title cannot be empty": "শিরোনাম খালি রাখা যাবে না",
      "Cannot set reminder for past time":
          "অতীত সময়ের জন্য রিমাইন্ডার সেট করা যাবে না",
      "Reminder added successfully": "রিমাইন্ডার সফলভাবে যোগ করা হয়েছে",
      "Failed to add reminder": "রিমাইন্ডার যোগ করতে ব্যর্থ হয়েছে",
      "Reminder updated successfully": "রিমাইন্ডার সফলভাবে আপডেট হয়েছে",
      "Failed to update reminder": "রিমাইন্ডার আপডেট করতে ব্যর্থ হয়েছে",
      "Failed to delete reminder": "রিমাইন্ডার মুছতে ব্যর্থ হয়েছে",
      "New Reminder": "নতুন রিমাইন্ডার",
      "Never forget important tasks add your reminder now.":
          "গুরুত্বপূর্ণ কাজ ভুলে যাবেন না, এখনই আপনার রিমাইন্ডার যোগ করুন।",
      "Description": "বিবরণ",
      "Time:": "সময়:",
      "Update Reminder": "রিমাইন্ডার আপডেট করুন",
      "Add Reminder": "রিমাইন্ডার যোগ করুন",
      "Delete Reminder": "রিমাইন্ডার মুছুন",
      "Are you sure you want to delete this reminder?":
          "আপনি কি নিশ্চিত যে এই রিমাইন্ডারটি মুছে ফেলতে চান?",
      "Reminder removed successfully": "রিমাইন্ডার সফলভাবে মুছে ফেলা হয়েছে",
      "You’re using a guest account. Logging out will permanently remove access to your data. Make your account permanent to keep your data safe.":
          "আপনি অতিথি (গেস্ট) অ্যাকাউন্ট ব্যবহার করছেন। লগ আউট করলে আপনার ডেটায় স্থায়ীভাবে প্রবেশাধিকার হারাবেন। আপনার ডেটা সুরক্ষিত রাখতে অ্যাকাউন্টটি স্থায়ী করুন।",
      ...
      "You're using Trackio offline. Please connect to the internet.":
          "আপনি Trackio অফলাইনে আছেন। অনুগ্রহ করে ইন্টারনেটে সংযুক্ত করুন।",
      "This email is not linked to any account.":
          "এই ইমেইলটি কোনো অ্যাকাউন্টের সাথে সংযুক্ত নয়।",
      "Keep a clear record of where your money goes.":
          "আপনার টাকা কোথায় খরচ হচ্ছে তার একটি স্পষ্ট হিসাব রাখুন।",
      ...
      "Enter your email and we’ll send a password reset link.":
          "আপনার ইমেইল লিখুন, আমরা একটি পাসওয়ার্ড রিসেট লিংক পাঠাবো।",
      "Enter your email address..": "আপনার ইমেইল ঠিকানা লিখুন..",
      ...
      "Are you sure you want to delete this transaction?":
          "আপনি কি নিশ্চিতভাবে এই লেনদেনটি মুছতে চান?",
      "Cancel": "বাতিল",
      "Delete": "মুছুন",
      ...
      "No lent or borrow transactions":
          "কোনো ধার দেওয়া বা ধার নেওয়ার লেনদেন নেই",
      "You Need to Pay.": "আপনাকে পরিশোধ করতে হবে।",
      "Borrow means money you received and must repay later.":
          "ধার মানে অন্যের কাছ থেকে নেওয়া টাকা, যা পরে পরিশোধ করতে হয়।",
      "Borrow": "ধার নেওয়া",
      "You Will Receive.": "আপনি পাবেন।",
      "Lent means giving money to another person with the expectation that it will be returned in the future.":
          "ধার দেওয়া মানে অন্য কাউকে টাকা দেওয়া, যা ভবিষ্যতে ফেরত পাওয়ার আশা করা হয়।",
      "Lent": "ধার দেওয়া",
      ...
      "Make Permanent Account": "স্থায়ী অ্যাকাউন্ট তৈরি করুন",
      "Your account is already permanent.":
          "আপনার অ্যাকাউন্ট ইতিমধ্যেই স্থায়ী।",
      "Done": "সম্পন্ন",
      ...
      "OR": "অথবা",
      "This upgrades your guest account to a permanent account.":
          "এটি আপনার গেস্ট অ্যাকাউন্টকে স্থায়ী অ্যাকাউন্টে রূপান্তর করবে।",
      "Email and password are required.": "ইমেইল এবং পাসওয়ার্ড আবশ্যক।",
      "Invalid email address.": "অবৈধ ইমেইল ঠিকানা।",
      "Password must be at least 6 characters.":
          "পাসওয়ার্ড কমপক্ষে ৬ অক্ষরের হতে হবে।",
      "No user session found. Please login again.":
          "কোনো ইউজার সেশন পাওয়া যায়নি। অনুগ্রহ করে আবার লগইন করুন।",
      "This account is already permanent.":
          "এই অ্যাকাউন্টটি ইতিমধ্যেই স্থায়ী।",
      "Permanent account created!": "স্থায়ী অ্যাকাউন্ট তৈরি হয়েছে!",
      "This email is already in use. Try logging in instead.":
          "এই ইমেইলটি ইতিমধ্যেই ব্যবহৃত হচ্ছে। লগইন করার চেষ্টা করুন।",
      "This credential is already linked to another account.":
          "এই তথ্যটি ইতিমধ্যেই অন্য একটি অ্যাকাউন্টের সাথে যুক্ত।",
      "Failed. Try again.": "ব্যর্থ হয়েছে। আবার চেষ্টা করুন।",
      "Google connected! Account is now permanent.":
          "গুগল সংযুক্ত হয়েছে! অ্যাকাউন্ট এখন স্থায়ী।",
      "This Google account is already linked to another user.":
          "এই গুগল অ্যাকাউন্টটি ইতিমধ্যেই অন্য একজন ইউজারের সাথে যুক্ত।",
      "An account already exists with the same email but different sign-in method.":
          "একই ইমেইল দিয়ে অন্য একটি সাইন-ইন পদ্ধতিতে অ্যাকাউন্ট রয়েছে।",
      "Google sign-in failed.": "গুগল সাইন-ইন ব্যর্থ হয়েছে।",
      "Logging out...": "লগ আউট হচ্ছে...",
      "Logged out successfully": "সফলভাবে লগ আউট হয়েছে",
      "Unable to logout. Please try again.":
          "লগ আউট করা যায়নি। অনুগ্রহ করে আবার চেষ্টা করুন।",
      "Logout": "লগ আউট",
      ...
      "Note: Password is required to delete an email/password account.":
          "নোট: ইমেইল/পাসওয়ার্ড অ্যাকাউন্ট মুছতে পাসওয়ার্ড প্রয়োজন।",
      "You are using a Guest account. Deleting will remove this guest profile.":
          "আপনি একটি গেস্ট অ্যাকাউন্ট ব্যবহার করছেন। মুছে ফেললে এই গেস্ট প্রোফাইলটি সরিয়ে দেওয়া হবে।",
      ...
      "For security, please login again and then delete your account.":
          "নিরাপত্তার জন্য অনুগ্রহ করে আবার লগইন করে তারপর অ্যাকাউন্ট মুছুন।",
      "Account deletion failed.": "অ্যাকাউন্ট মুছে ফেলা ব্যর্থ হয়েছে।",
      "Account deletion failed. Please try again.":
          "অ্যাকাউন্ট মুছে ফেলা ব্যর্থ হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।",
      "Current Password": "বর্তমান পাসওয়ার্ড",
      "Please enter your current password":
          "অনুগ্রহ করে আপনার বর্তমান পাসওয়ার্ড লিখুন",
      ...
      "No account exists with this email.":
          "এই ইমেইলের সাথে কোনো অ্যাকাউন্ট পাওয়া যায়নি।",
      "This email is registered with Google. Please sign in with Google.":
          "এই ইমেইলটি গুগলের সাথে নিবন্ধিত। অনুগ্রহ করে গুগল দিয়ে সাইন ইন করুন।",
      "Reset link sent. Check inbox/spam.":
          "রিসেট লিংক পাঠানো হয়েছে। ইনবক্স বা স্প্যাম ফোল্ডার দেখুন।",
      ...
      "Unable to continue as guest. Please try again.":
          "গেস্ট হিসেবে চালিয়ে যাওয়া সম্ভব হয়নি। অনুগ্রহ করে আবার চেষ্টা করুন।",
      "Logging in...": "লগইন হচ্ছে...",
      "Login failed. Please try again.":
          "লগইন ব্যর্থ হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।",
      "Logged in successfully": "সফলভাবে লগইন হয়েছে",
      "No user found with this email.":
          "এই ইমেইলের সাথে কোনো ইউজার পাওয়া যায়নি।",
      ...
      "Could not save user info. Please try again.":
          "ইউজারের তথ্য সংরক্ষণ করা যায়নি। অনুগ্রহ করে আবার চেষ্টা করুন।",
      "This email is already registered. Try logging in.":
          "এই ইমেইলটি ইতোমধ্যে নিবন্ধিত। লগইন করার চেষ্টা করুন।",
      "Please enter a valid email address.":
          "অনুগ্রহ করে একটি সঠিক ইমেইল ঠিকানা লিখুন।",
      "Password is too weak. Use at least 6 characters.":
          "পাসওয়ার্ড দুর্বল। কমপক্ষে ৬টি অক্ষর ব্যবহার করুন।",
      "Email/password accounts are not enabled in Firebase Console.":
          "Firebase Console-এ ইমেইল/পাসওয়ার্ড লগইন চালু করা নেই।",
      "No internet connection. Please check your network.":
          "ইন্টারনেট সংযোগ নেই। অনুগ্রহ করে নেটওয়ার্ক চেক করুন।",
      "Too many attempts. Please wait and try again later.":
          "অনেকবার চেষ্টা করা হয়েছে। অনুগ্রহ করে কিছুক্ষণ পর আবার চেষ্টা করুন।",
      "This account has been disabled. Contact support.":
          "এই অ্যাকাউন্টটি নিষ্ক্রিয় করা হয়েছে। সাপোর্টে যোগাযোগ করুন।",
      "All": "সব",
      "Data & Sync": "ডাটা ও সিঙ্ক",
      "Troubleshooting": "সমস্যা সমাধান",
      "How do I log in as Guest?": "আমি কীভাবে গেস্ট হিসেবে লগইন করবো?",
      "Continue as Guest' on the login screen. Your data will be stored under an anonymous Firebase UID. If you logout as guest, data may be lost.":
          "লগইন স্ক্রিনে 'Continue as Guest' চাপুন। আপনার ডাটা একটি অ্যানোনিমাস Firebase UID-এর অধীনে সংরক্ষণ হবে। গেস্ট হিসেবে লগআউট করলে ডাটা হারিয়ে যেতে পারে।",
      "How do I change my password?": "আমি কীভাবে পাসওয়ার্ড পরিবর্তন করবো?",
      "Password change is available only for Email/Password accounts. Go to Settings → Security → Change Password.":
          "পাসওয়ার্ড পরিবর্তন শুধুমাত্র ইমেইল/পাসওয়ার্ড অ্যাকাউন্টের জন্য উপলব্ধ। Settings → Security → Change Password এ যান।",
      ...
      "Please fill title and details.":
          "অনুগ্রহ করে শিরোনাম ও বিস্তারিত লিখুন।",
      "Please provide title and details.":
          "অনুগ্রহ করে শিরোনাম ও বিস্তারিত দিন।",
      "Submitting report...": "রিপোর্ট পাঠানো হচ্ছে...",
      "Thanks! Your report has been submitted.":
          "ধন্যবাদ! আপনার রিপোর্ট পাঠানো হয়েছে।",
      "Failed to submit report. Please try again.":
          "রিপোর্ট পাঠাতে ব্যর্থ হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।",
      "Search questions (sync, guest, password...)":
          "প্রশ্ন খুঁজুন (সিঙ্ক, গেস্ট, পাসওয়ার্ড...)",
      "Contact Support": "সাপোর্টে যোগাযোগ করুন",
      "Need help quickly? Contact us using one of the options below.":
          "দ্রুত সাহায্য দরকার? নিচের অপশনগুলোর যেকোনো একটি ব্যবহার করে আমাদের সাথে যোগাযোগ করুন।",
      "Frequently Asked Questions": "সচরাচর জিজ্ঞাসিত প্রশ্নাবলী",
      "No results found": "কোনো ফলাফল পাওয়া যায়নি",
      "Try searching with different keywords or clear filters.":
          "ভিন্ন কীওয়ার্ড দিয়ে খুঁজুন অথবা ফিল্টার মুছে দিন।",
      ...
      "delete_warning_3":
          "• এই অ্যাকাউন্টটি মুছে ফেলার পর আর পুনরুদ্ধার করা যাবে না।",
      "You are signed in with Google/Apple/other provider.":
          "আপনি Google/Apple বা অন্য কোনো প্রোভাইডার দিয়ে সাইন ইন করেছেন।",
      "If deletion fails, you may need to re-login and try again.":
          "ডিলিট করতে ব্যর্থ হলে, আপনাকে আবার লগইন করে পুনরায় চেষ্টা করতে হতে পারে।",
      ...
      "This item will be deleted permanently.":
          "এই আইটেমটি স্থায়ীভাবে মুছে যাবে।",
      ...
      "Anything you want to remember about this saving...":
          "এই সেভিংস সম্পর্কে যা মনে রাখতে চান...",
