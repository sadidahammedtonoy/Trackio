...
class addTranscations extends StatelessWidget {
        ...
        _InfoCard(
          ...
          content: TextField(
            ...
            decoration: const InputDecoration(
              ...
              errorBorder: InputBorder.none,
              focusedErrorBorder: InputBorder.none,
              contentPadding: EdgeInsets.zero, // Optional
            ),
            style: TextStyle(
  ...
  void _handleSubmission() {
    ...
    final model = addTranModel(
      ...
      category: isLentBorrow ? personNameController.text.trim() : controller.selectedCategoryId.value!,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    CupertinoButton(child: Text("Done".tr), onPressed: () {
